...
build_app:
	$(CC) -I ./library/SFML-2.5.1/include ./src/main.cpp -o ./build/main.o
	$(CC) -L ./library/SFML-2.5.1/lib -o ./build/main.exe ./build/main.o ./build/renderer.o -lsfml-graphics -lsfml-window -lsfml-system
